      ...
      <Grid borderRadius="xl">
        {
          ...
          props.action.action === "bugfix" ? (
            <ActionElement
              ...
              tooltip={"Fix known bugs. Bugs are discovered after unit testing"}
            >
          ...
          props.action.action === "unittest" ? (
            <ActionElement
              ...
              tooltip={"Test specific parts for functionality and/or bugs"}
            >
              <FormControl display="flex" justifyContent="end">
                <Switch
                  onChange={(event) =>
          ...
          props.action.action === "integrationtest" ? (
            <ActionElement
              ...
              tooltip={"Integration testing should be done after unit testing and bug fixing"}
            >
              <ActionToggle
                onEventbutton={(event) =>
                  props.onSelectAction({
          ...
          props.action.action === "meetings" ? (
            <ActionElement
              ...
              tooltip={"Meetings are important for familiarity, set them regulary"}
            >
              <Flex w="full">
                <ActionSlider
                  onSlide={(event) =>
          ...
          props.action.action === "training" ? (
            <ActionElement
              ...
              tooltip={"Training is important for motivation and familiarity"}
            >
              <Flex w="full">
                <ActionSlider
                  onSlide={(event) =>
          ...
          props.action.action === "teamevent" ? (
            <ActionElement
              ...
              tooltip={"Team events reduce stress and rise motivation"}
            >
              <ActionToggle
                onEventbutton={(event) =>
                  props.onSelectAction({
          ...
          props.action.action === "salary" ? (
            <ActionElement
              ...
              tooltip={"Different salarys for the employees can be set here"}
            >
              <ActionSelect
          ...
          props.action.action === "overtime" ? (
            <ActionElement
              ...
              tooltip={"Overtime could be neccessary for the project but will rise stress"}
            >
              <ActionSelect
                onActionSelect={(event) =>
                  props.onSelectAction({

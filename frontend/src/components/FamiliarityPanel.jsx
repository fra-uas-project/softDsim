    ...
    return (
        <>
            <Text size='lg' fontWeight='bold' mb='2' color='black'>
                ...
                Senior Developer
            <CircularProgress value={40} color='red.400' size='65'>
            ...
            <GridItem w="100%" h="10">
                Senior Frontend
            <CircularProgress value={30} color='red.400' size='65'>
            <CircularProgressLabel>30%</CircularProgressLabel>
            </CircularProgress></GridItem>
            
            <GridItem w="100%" h="10">
                Junior Developer
            <CircularProgress value={75} color='red.400' size='65'>
            <CircularProgressLabel>75%</CircularProgressLabel>
            </CircularProgress></GridItem>
            <GridItem w="100%" h="10">
                Some Developer
            <CircularProgress value={60} color='red.400' size='65'>
            <CircularProgressLabel>60%</CircularProgressLabel>
            </CircularProgress></GridItem>
            <GridItem w="100%" h="10">
                Backend Developer
            <CircularProgress value={15} color='red.400' size='65'>
